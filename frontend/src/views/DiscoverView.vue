...
const form = reactive({ query: '', sort: 'latest' });
    ...
    <section class="app-panel" aria-labelledby="discover-title">
      ...
      <div class="discover-tools">
        <form class="discover-search" role="search" @submit.prevent="submitSearch">
          ...
          <button class="search-submit" type="submit">搜索</button><button class="search-reset" type="button" :disabled="!form.query && form.sort === 'latest'" @click="resetSearch">重置</button>
        </form>
