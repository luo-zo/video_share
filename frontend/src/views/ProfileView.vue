...
<template>
  <div class="app-content">
    <section class="app-panel" aria-labelledby="profile-title">
      <div class="panel-heading"><div><span class="panel-kicker">MY ORBIT / LIBRARY</span><h2 id="profile-title" ref="title" tabindex="-1">{{ auth.user?.nickname || '个人中心' }}</h2><p>管理投稿，也重温喜欢过的片段。</p></div></div>
